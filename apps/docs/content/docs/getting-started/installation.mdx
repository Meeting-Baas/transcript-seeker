...
1. **MeetingBaas Proxy Configuration**
...
These values are used by the api to perform google authentication. Please follow the [guide](/docs/concepts/google)
...
These values are used by the api to store user autehtncation data. Please follow the [guide](/docs/concepts/database)

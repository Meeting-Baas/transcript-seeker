...
export function ServerAlert(props: { mode: ServerAvailability; contrast?: 'default' | 'bright' }) {
  return (
    <>
      {props.mode === 'loading' ? (
        <Alert
          className={cn('border-gray-300/30 bg-gray-300/10 dark:border-gray-700/30 dark:bg-gray-700/10', {
            'border-gray-300/60 bg-gray-300/20 dark:border-gray-700/60 dark:bg-gray-700/20': props.contrast === 'bright',
          })}
        >
      ...
      {props.mode === 'local' ? (
        <Alert
          className={cn('border-blue-300/30 bg-blue-300/10 dark:border-blue-700/30 dark:bg-blue-700/10', {
            'border-blue-300/60 bg-blue-300/20 dark:border-blue-700/60 dark:bg-blue-700/20': props.contrast === 'bright',
          })}
        >
      ...
      {props.mode === 'error' ? (
        <Alert
          className={cn('border-yellow-300/30 bg-yellow-300/10 dark:border-yellow-700/30 dark:bg-yellow-700/10', {
            'border-yellow-300/60 bg-yellow-300/20 dark:border-yellow-700/60 dark:bg-yellow-700/20': props.contrast === 'bright',
          })}
        >
